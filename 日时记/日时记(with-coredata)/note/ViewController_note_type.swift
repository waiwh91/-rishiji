...
class ViewController_note_type: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    //let ViewController_empty_note : ViewController_empty_note? = nil
    ...
    @IBAction func enter(_ sender: Any) {
        ...
        if self.temp == 1{
            ...
            let destination = sb.instantiateViewController(withIdentifier: "empty_note")
            self.present(destination, animated: true , completion: nil)
        }
        if self.temp == 2{
            let sb = UIStoryboard(name: "Main", bundle: nil)
            let destination = sb.instantiateViewController(withIdentifier: "todo")
            self.present(destination, animated: true , completion: nil)
        }
        if self.temp == 3{
            let sb = UIStoryboard(name: "Main", bundle: nil)
            let destination = sb.instantiateViewController(withIdentifier: "recording")
            self.present(destination, animated: true , completion: nil)
        }
    }
